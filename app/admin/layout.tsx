                ...
                <aside className="w-64 bg-white shadow-lg min-h-screen border-r border-gray-200 hidden md:flex md:flex-col">
                    ...
                    <nav className="flex-1 p-4 space-y-2">
                        {navItems.map((item) => (
                            <Link
                                ...
                                `}
                            >
                                <span className={pathname === item.href ? "text-red-600" : "text-gray-400"}>
                                    {item.icon}
                                </span>
                                {item.name}
                            </Link>
                    ...
                    <div className="p-4 border-t border-gray-100 space-y-2">
                        ...
                        <Link
                            href="/"
                            target="_blank"
                            className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-gray-600 hover:bg-red-50 hover:text-red-600 transition-all duration-200"
                        >
